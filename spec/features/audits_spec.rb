...
feature "Audits" do
  ...
  scenario "work" do
    ...
    a_req_1 = AuditedRequest.order(:created_at).last
    ...
    a_req_2 = AuditedRequest.order(:created_at).last
    ...
    a_change_2 = AuditedChange.order(:created_at).last
    ...
    a_req_3 = AuditedRequest.order(:created_at).last
